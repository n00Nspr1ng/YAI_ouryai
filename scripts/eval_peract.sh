...
relative_action=0
seed=1
checkpoint=eval_logs/best.pth
quaternion_format=xyzw

num_ckpts=${#tasks[@]}
for ((i=0; i<$num_ckpts; i++)); do
    CUDA_LAUNCH_BLOCKING=1 python YAI_ouryai/evaluation/evaluate_peract.py \
    --tasks ${tasks[$i]} \
    ...
    --instructions instructions/peract/place_cups/instructions.pkl \
    --variations {0..60} \
    --max_tries $max_tries \
    --max_steps 25 \
    --seed $seed \
