...
data_dir=./data/yaicon-ouryai/test/ #Not used! 
...
for ((i=0; i<$num_ckpts; i++)); do
    for ((j=0; j<$num_seeds; j++)); do
        CUDA_LAUNCH_BLOCKING=1 python YAI_ouryai/evaluation/evaluate_yai.py \
        --tasks ${tasks[$i]} \
        ...
        --output_file eval_logs/$exp/seed${seeds[$j]}/${tasks[$i]}2 \
