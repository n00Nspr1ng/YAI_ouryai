main_dir=pick_and_lift #Actor_18Peract_100Demo_multitask

dataset=data/pick_and_lift/packaged/train
valset=data/pick_and_lift/packaged/val
...
CUDA_LAUNCH_BLOCKING=1 torchrun --nproc_per_node $ngpus --master_port $RANDOM \
    ...
    --dataset $dataset \
    --valset $valset \
    --instructions instructions/pick_and_lift/instructions.pkl \
